...
from onescience.modules.equivariant.mace_wrapper_ops import (
...
from onescience.utils.mace.tools.compile import simplify_if_compile
...
#from onescience.utils.mace.tools.utils import LAMMPS_MP
from onescience.datapipes.materials.tools.utils import LAMMPS_MP

from onescience.modules.func_utils.mace_irreps_tools import mask_head, reshape_irreps, tp_out_irreps_with_instructions
