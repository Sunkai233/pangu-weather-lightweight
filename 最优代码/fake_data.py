...
if __name__ == "__main__":
    ...
    generate_stats(cfg_datapipe.dataset.stats_dir, len(atm_vars))

    get_static(cfg_datapipe.dataset, 'z', 'geopotential')
    get_static(cfg_datapipe.dataset, 'lsm', 'land_sea_mask')
